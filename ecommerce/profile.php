	        	...
	        	<div class="col-sm-9">
					...
					<div class="panel panel-primary">
 					 <div class="panel-heading">
   					 <h3 class="panel-title">Bem vindo <?php echo $user['firstname'].' '.$user['lastname']; ?> !</h3>
					  
						<span class="pull-right">
	        			<a href="#edit" class="btn btn-info btn-flat btn-sm" data-toggle="modal"><i class="fa fa-edit"></i> Editar perfil</a>
	        			</span>
