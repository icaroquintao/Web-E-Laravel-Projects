		...
		try{
			...
			foreach($stmt as $row){
				...
				$output['list'] .= "
						...
						<a class='dropdown-item' href='betaproduct.php?product=".$row['slug']."'>
							<div class='pull-right'>
							<img src='".$image."' class='thumbnail' alt='User Image' width='40px' height='40px'>
							
							".$productname."
							<strong><small>&times; ".$row['quantity']."</small></strong>
							<!--<small>".$row['catname']."</small>-->
							</div>
